...
E-vehicles are becoming increasingly popular, however, e-charging stations are not yet widely available. Tourists coming to South Tyrol with their e-vehicles also face this problem, especially if their selected accommodation is not near a charging station.
...
The web component is visually pleasing, easy-to-use, brings value to the user, allows for greener tourism, allows for dynamic accommodation type, distance from e-charging station and language selection. The web component comes in 3 languages (English, Italian, and German).
